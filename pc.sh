...
arch-chroot /mnt/ sudo -u $username yay -S transset-df hardinfo debtab volctl libreoffice-extension-languagetool cups-xerox-b2xx --noconfirm
#umount -R /mnt
#reboot
