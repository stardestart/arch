...
arch-chroot /mnt/ sudo -u $username yay -S transset-df hardinfo debtap volctl libreoffice-extension-languagetool cups-xerox-b2xx ttf-unifont-csur --noconfirm
#umount -R /mnt
#reboot
