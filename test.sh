...
type = custom/script
exec = echo " 🥷"
click-left = polybar-msg action i2p1 module_hide; polybar-msg action i2p2 hook 1; sleep 0.1; polybar-msg action i2p2 hook 0; polybar-msg action i2p1 module_show; xlinks -g
