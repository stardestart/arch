...
export QT_STYLE_OVERRIDE=Breeze-Dark #Использовать Breeze-Dark в качестве стиля Qt по умолчанию
...
!Размер курсора.
Xcursor.size: 24
Xcursor.theme: Breeze-Dark' | tee /mnt/home/"$username"/.Xresources /mnt/root/.Xresources
#
...
gtk-cursor-theme-name=Breeze-Dark
gtk-font-name=Fantasque Sans Mono Bold Italic '"$font"'
gtk-icon-theme-name=Papirus-Dark
gtk-theme-name=Breeze-Dark' | tee /etc/gtk-3.0/settings.ini /etc/gtk-4.0/settings.ini
echo 'gtk-application-prefer-dark-theme="true"
gtk-cursor-theme-name="Breeze-Dark"
gtk-font-name="Fantasque Sans Mono Bold Italic '"$font"'"
gtk-icon-theme-name="Papirus-Dark"
gtk-theme-name="Breeze-Dark"' > /mnt/usr/share/gtk-2.0/gtkrc
#
