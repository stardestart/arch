...
echo -e "\033[34mСброс переменных и размонтирование разделов, на случай повторного запуска скрипта.\033[0m"
swapoff -a
umount -R /mnt
...
echo -e "\033[34mСетевое устройство:"$netdev"\033[0m"
#
#Определяем часовой пояс.
echo -e "\033[34mОпределяем часовой пояс.\033[0m"
timedatectl set-timezone "$(curl https://ipapi.co/timezone)"
echo -e "\033[34mЧасовой пояс:"$(curl https://ipapi.co/timezone)"\033[0m"
#
#Определяем физический диск на который будет установлена ОС.
echo -e "\033[34mОпределяем физический диск на который будет установлена ОС.\033[0m"
...
echo -e "\033[34mФизический диск на который будет установлена ОС:"$sysdisk"\033[0m"
#
#Определяем есть ли nvme контролер системного диска.
echo -e "\033[34mОпределяем есть ли nvme контролер системного диска.\033[0m"
...
echo -e "\033[34mСбор данных пользователя.\033[0m"
echo -e "\033[47m\033[30mВведите имя компьютера:\033[0m\033[36m";read -p ">" hostname
echo -e "\033[47m\033[30mВведите имя пользователя:\033[0m\033[36m";read -p ">" username
echo -e "\033[47m\033[30mВведите пароль для "$username":\033[0m\033[36m";read -p ">" passuser
echo -e "\033[47m\033[30mВведите пароль для root:\033[0m\033[36m";read -p ">" passroot
echo -e "\033[34mВыберите разрешение монитора:\033[0m"
PS3="$(echo -e "\033[47m\033[30mПункт №:\033[0m\033[36m
>")"
...
do
    case "$resolution" in
        ...
        "~4K.")
            ...
            break
            ;;
        *) echo -e "\033[34mЧто значит - "$REPLY"? До трёх посчитать не можешь и Arch Linux ставишь?\033[36m";;
    esac
done
#
#Вычисление swap.
echo -e "\033[34mВычисление swap.\033[0m"
...
echo -e "\033[34mРазмер SWAP раздела: $swap\033[0m"
#
#Разметка системного диска.
echo -e "\033[34mРазметка системного диска.\033[0m"
if [ -z "$(efibootmgr | grep Boot)" ];
    then
        echo -e "\033[34mLegacy boot.\033[0m"
...
swapon /dev/"$sysdisk""$p3"
        ...
        echo -e "\033[34mUEFI boot.\033[0m"
fdisk /dev/"$sysdisk"<<EOF
g
n
1
...
echo -e "\033[34mУстановка и настройка программы для фильтрования зеркал и обновление ключей.\033[0m"
...
#
#Установка ОС.
echo -e "\033[34mУстановка ОС.\033[0m"
pacstrap -K /mnt base base-devel linux-zen linux-zen-headers linux-firmware
#
#Установка часового пояса.
echo -e "\033[34mУстановка часового пояса.\033[0m"
arch-chroot /mnt ln -sf /usr/share/zoneinfo/"$(curl https://ipapi.co/timezone)" /etc/localtime
arch-chroot /mnt hwclock --systohc
#
#Настройка локали.
echo -e "\033[34mНастройка локали.\033[0m"
...
echo -e "\033[34mСоздание пользователя.\033[0m"
...
#
#Установим загрузчик.
echo -e "\033[34mУстановка загрузчика.\033[0m"
if [ -z "$(efibootmgr | grep Boot)" ];
    then
...
echo -e "\033[34mУстановка микроинструкций для процессора.\033[0m"
...
echo -e "\033[34mНастройка установщика.\033[0m"
arch-chroot /mnt sed -i "s/#Color/Color/" /etc/pacman.conf
echo -e "[multilib]\nInclude = /etc/pacman.d/mirrorlist" >> /mnt/etc/pacman.conf
#
#Настройка sysrq.
echo -e "\033[34mНастройка sysrq.\033[0m"
echo "kernel.sysrq=1" > /mnt/etc/sysctl.d/99-sysctl.conf
#
#Установим видеодрайвер.
echo -e "\033[34mУстановка видеодрайвера.\033[0m"
...
echo -e "\033[34mПоиск не смонтированных разделов.\033[0m"
...
echo -e "\033[34mПеренос genfstab.\033[0m"
genfstab -pU /mnt >> /mnt/etc/fstab
#
#Создание общего конфига загрузки оконного менеджера.
echo -e "\033[34mСоздание xinit.\033[0m"
...
echo -e "\033[34mСоздание 00-keyboard.\033[0m"
...
echo -e "\033[34mСоздание sane.d.\033[0m"
mkdir -p /mnt/etc/sane.d
echo -e "localhost\n192.168.0.0/24" >> /mnt/etc/sane.d/net.conf
#
echo -e "\033[34mФормируется конфиг conky.\033[0m"
#
...
echo -e "\033[34mСоздание bash_profile.\033[0m"
echo '[[ -f ~/.profile ]] && . ~/.profile' > /mnt/home/"$username"/.bash_profile
#
#Создание bashrc.
echo -e "\033[34mСоздание bashrc.\033[0m"
...
#
#Создание profile.
echo -e "\033[34mСоздание profile.\033[0m"
...
echo -e "\033[34mСоздание конфига сервера уведомлений.\033[0m"
echo '[D-BUS Service]
...
echo -e "\033[34mСоздание конфига picom.\033[0m"
...
#
#Создание xresources.
echo -e "\033[34mСоздание xresources.\033[0m"
...
echo -e "\033[34mСоздание конфига i3.\033[0m"
...
echo -e "\033[34mСоздание конфига i3status.\033[0m"
...
echo -e "\033[34mСоздание конфига redshift.\033[0m"
echo '[redshift]
allowed=true
system=false
...
echo -e "\033[34mОтключение запроса пароля.\033[0m"
...
echo -e "\033[34mСоздание конфига qt5ct.\033[0m"
...
echo -e "\033[34mСоздание конфига gtk.\033[0m"
...
echo -e "\033[34mСоздание конфига lxqt-panel.\033[0m"
...
echo -e "\033[34mСоздание конфига kdeglobals.\033[0m"
...
echo -e "\033[34mПередача интернет настроек в установленную систему.\033[0m"
...
#
#Автозапуск служб.
echo -e "\033[34mАвтозапуск служб.\033[0m"
...
echo -e "\033[34mПередача прав созданному пользователю.\033[0m"
arch-chroot /mnt chown -R "$username" /home/"$username"/
#
#Установка помощника yay для работы с AUR.
echo -e "\033[34mУстановка помощника yay для работы с AUR.\033[0m"
...
echo -e "\033[34mУстановка программ из AUR.\033[0m"
...
echo -e "\033[34mУстановка завершена, после перезагрузки вас встретит настроенная и готовая к работе ОС.\033[0m"
#fdisk -l
lsblk -l
