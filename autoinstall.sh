...
arch-chroot /mnt sudo -u "$username" yay -S hardinfo debtap libreoffice-extension-languagetool minq-ananicy-git auto-cpufreq vkbasalt kde-cdemu-manager --noconfirm
#
#Автозапуск служб.
